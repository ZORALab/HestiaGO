...
func S8_BitsResizeUINT8(input *uint8, size uint16, withSign bool) hestiaERROR.Error {
...
func M8_BitsResizeUINT8(input *uint8, size uint16, withSign bool) hestiaERROR.Error {
	switch hestiaMATH.S8_Resize(input, size, withSign) {
	case hestiaMATH.ERROR_OK:
		return hestiaERROR.OK
	case hestiaMATH.ERROR_INPUT_INVALID:
