...
func test_cases_M64_Length() []*hestiaTESTING.Scenario {
	return []*hestiaTESTING.Scenario{
		{
			Description: `
test hestiaNUMBER/M64_BitsLengthUINT64 is able to process 0-bits value.
`,
			Switches: []string{
				cond_BITS_0,
			},
			...
			Description: `
test hestiaNUMBER/M64_BitsLengthUINT64 is able to process 8-bits value.
`,
			Switches: []string{
				cond_BITS_8,
			},
			...
			Description: `
test hestiaNUMBER/M64_BitsLengthUINT64 is able to process 16-bits value.
`,
			Switches: []string{
				cond_BITS_16,
			},
			...
			Description: `
test hestiaNUMBER/M64_BitsLengthUINT64 is able to process 32-bits value.
`,
			Switches: []string{
				cond_BITS_32,
			},
			...
			Description: `
test hestiaNUMBER/M64_BitsLengthUINT64 is able to process 64-bits value.
`,
			Switches: []string{
				cond_BITS_64,
			},
...
func Test_M64_Length(t *testing.T) {
	scenarios := test_cases_M64_Length()

	for i, s := range scenarios {
		s.ID = uint64(i)
		s.Name = "hestiaNUMBER/M64_BitsLengthUINT64 API"
...
func assert_M64_Length_output(s *hestiaTESTING.Scenario, output uint64) bool {
