...
func S32_BitsResizeUINT32(input *uint32, size uint16, withSign bool) hestiaERROR.Error {
...
func M32_BitsResizeUINT32(input *uint32, size uint16, withSign bool) hestiaERROR.Error {
	switch hestiaMATH.S32_Resize(input, size, withSign) {
	case hestiaMATH.ERROR_OK:
		return hestiaERROR.OK
	case hestiaMATH.ERROR_INPUT_INVALID:
