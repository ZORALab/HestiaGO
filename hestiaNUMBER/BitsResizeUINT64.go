...
func S64_BitsResizeUINT64(input *uint64, size uint16, withSign bool) hestiaERROR.Error {
...
func M64_BitsResizeUINT64(input *uint64, size uint16, withSign bool) hestiaERROR.Error {
	switch hestiaMATH.S64_Resize(input, size, withSign) {
	case hestiaMATH.ERROR_OK:
		return hestiaERROR.OK
	case hestiaMATH.ERROR_INPUT_INVALID:
