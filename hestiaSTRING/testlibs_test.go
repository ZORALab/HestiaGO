...
const (
	...
	cond_WRITER_NIL    = "writer is nil"
	cond_WRITER_PROPER = "writer is a proper interface"

	cond_ENGINE_NIL    = "engine is nil"
	cond_ENGINE_PROPER = "engine is normal and proper one"
)
